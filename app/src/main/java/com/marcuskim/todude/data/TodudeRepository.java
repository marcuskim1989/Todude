package com.marcuskim.todude.data;
...
import com.marcuskim.todude.util.TaskRoomDatabase;

import java.util.List;

public class TodudeRepository {
    private final TaskDao taskDao;
    private final LiveData<List<Task>> allTasks;

    public TodudeRepository(Application application) {
